...
const createSemesterRegistration = catchAsync(async (req: Request, res: Response)=>{
    const result = await constSemesterRegistrationService.createSemesterRegistrationIntiDB(req.body);
...
const getSingleSemesterRegistration = catchAsync(async (req: Request, res: Response)=>{
    const {id} = req.params
    const result = await constSemesterRegistrationService.getSingleSemesterRegistrationFromDB(id);
...
const updateSingleSemesterRegistration = catchAsync(async (req: Request, res: Response)=>{
    const {id} = req.params
    const result = await constSemesterRegistrationService.updateSemesterRegistrationIntoDB(id,req.body);
